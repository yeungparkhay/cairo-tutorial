# Exercise 3 - 15 puzzle (cont.)

# To compile: cairo-compile 3_dict.cairo --output 3_dict_compiled.json
# To run: cairo-run --program=3_dict_compiled.json --print_output --layout=small
